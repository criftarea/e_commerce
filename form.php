<?php
	...
	if($barang_id){
		...
		$keterangan_gambar = "(click if you want change the product image)"; //ketika user ingin mengubah
		$gambar = "<img src='".BASE_URL."image/barang/$gambar' style='width: 200px;vertical-align: middle;' />"; //menampilkan gambar yang di input
	} 
...
<form action="<?php echo BASE_URL."module/barang/action.php?barang_id=$barang_id"; ?>" method="POST" enctype="multipart/form-data">
	...
	<div class="element-form"> 
		<label>Product Image<?php echo $keterangan_gambar; ?></label>
		<span>
